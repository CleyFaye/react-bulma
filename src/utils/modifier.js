...
const bringSinglePropFromOptions
  = (classes, propList, options, helpers) => Object.keys(helpers).reduce(
    (classes2, helperName) => {
      ...
      return helpers[helperName](classes2, propList[propName]);
    },
    classes,
  );
 ...
 * - srOnly
 */
export const bringModifiers = (classes, propList, options) => addClassesFromOptions(
  classes,
  propList,
  options,
  {
    ...
    marginLess: {list: boolList, transform: boolProp("marginless")},
 ...
 * - backgroundColor
 */
export const bringColorOverride = (classes, propList, options) => addClassesFromOptions(
  classes,
  propList,
  options,
  {
 ...
 */
export const bringTextTransform = (classes, propList, options) => addClassesFromOptions(
  classes,
  propList,
  options,
  {
 ...
 */
export const bringAll = (classes, propList, optionsIn) => {
