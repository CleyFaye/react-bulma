...
/**
 * Props:
 * - size: either a division of 12 (1, 2, 3...), a textual name from Bulma
 ...
 * - offset: space before the column. Same convention as size.
...
Column.propTypes = {
  className: classNamePropType,
  size: viewportPrefixablePropType(columnSizePropTypes),
  offset: viewportPrefixablePropType(columnSizePropTypes),
